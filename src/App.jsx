      ...
      <div className="mortgage-calculator__wrapper">
        <div className="left">
          <div className="left-header">
            <h1 className="left-title">Mortgage Calculator</h1>
            <a className="clear-btn" href="#" onClick={handleClear}>
              Clear All
            </a>
          </div>
          <form id="form">
            ...
            <div className="input-box box">
              <h4 className="main-title">Mortgage Amount</h4>
            ...
            <div className="input-wrap">
              <div className="input-box">
                <h4 className="main-title">Mortgage Term</h4>
                <div className="input-block">
                  <input
                    value={term}
                    type="number"
              ...
              <div className="input-box">
                <h4 className="main-title">Interest Rate</h4>
                <div className="input-block">
                  <input
                    value={rate}
                    type="number"
            ...
            <div className="radio-wrapper">
              <h4 className="main-title">Mortgage Type</h4>
        ...
        <div className="right">
          <div className="right-header">
            <h1 className="right-title">Your results</h1>
